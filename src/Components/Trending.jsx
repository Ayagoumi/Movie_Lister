  ...
  return (
    <div className="container w-screen p-6 2xl:px-3 px-6 mx-auto">
      <div className="inline sm:flex mb-5">
        <h2 className="text-2xl font-bold text-gray-400 mr-4 border-b-2 border-gray-50 border-opacity-5">Trending</h2>
        <div className="flex flex-row gap-4 h-8 my-4 sm:my-0">
          <button
            className="flex bg-gray-200 px-3 rounded-md text-sm leading-4 py-2"
            onClick={getAll}
          >
            All
          </button>
