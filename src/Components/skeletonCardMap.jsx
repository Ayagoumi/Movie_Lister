    ...
    <div className="grid grid-cols-2 gap-4 xl:grid-cols-5 lg:grid-cols-4 md:grid-cols-3">
      {skeletonArray.map((item, index) => (
        <div class="max-w-sm w-full mx-auto">
          <div class="border border-gray-300 shadow rounded-md p-2 max-w-sm mx-auto animate-pulse flex space-x-4 w-full">
            <div class="rounded-md bg-gray-400 h-80 w-full"></div>
          </div>
